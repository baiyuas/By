...
public class StatusBarUtil {
    ...
    public static void setTransparentForFragment(FragmentActivity activity, View view) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        transparentStatusBar(activity);
        if (view != null) {
            ...
            int actionBarHeight = (int) getActionBarHeigth(activity);
            ViewGroup.LayoutParams ll = view.getLayoutParams();
            ll.height = actionBarHeight + statusHeight;
            view.setLayoutParams(ll);
            view.setPadding(0, statusHeight, 0, 0);
        }
    }

    private static float getActionBarHeigth(Context context) {
    ...
    public static void setFullStatusbarForFragment(FragmentActivity activity, @ColorInt int color, View view) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        if (view != null) {
